...
%% ------------ Level 1-- k-mode --------
parameter1={'l1_dis_method','SAX_MEANDIST','l1_dtw_bound',0.2,'l1_rep','SAX','l1_alphabet_size',8,'l1_compression_ratio',4,'l1_alg','k-modes'};
...
parameter2={'l2_dis_method','Euclid','l2_dtw_bound',0.2,'l2_rep','RAW','l2_alphabet_size',8,'l2_compression_ratio',2};
 [c2 ,error_rate,N_reduction_2lev,D,A]=clustering_l2_purify(c1,p,nor_traj,D,A,0,[],parameter2{:});
...
% weight=[];
%% --------------Level 3-------------------------------------------------
parameter3={'l3_dis_method','DTW','l3_dtw_bound',0.5,'l3_rep','SAX','l3_alphabet_size',8,'l3_compression_ratio',2,'l3_alg','k-medoids-keogh'};
